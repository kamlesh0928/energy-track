...
export function AlexaVoiceChat({ isOpen, onToggle, className }: AlexaVoiceChatProps) {
  ...
  const simulateVoiceResponse = (userMessage: string): string => {
    ...
    } else if (lowerMessage.includes('alert') || lowerMessage.includes('problem')) {
    ...
    } else if (lowerMessage.includes('shutdown') || lowerMessage.includes('restart')) {
    ...
    } else if (lowerMessage.includes('efficiency') || lowerMessage.includes('oee')) {
