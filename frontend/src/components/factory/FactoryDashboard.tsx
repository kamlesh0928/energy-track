...
// Initial factory state with comprehensive manufacturing processes
...
export function FactoryDashboard() {
  ...
  const [deviceActionFeedback, setDeviceActionFeedback] = useState<{ deviceId: string; action: 'shutdown' | 'restart' } | null>(null);
